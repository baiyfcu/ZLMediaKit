...
#ifndef ZLMEDIAKIT_SVAC3RTPCODEC_H
#define ZLMEDIAKIT_SVAC3RTPCODEC_H
 ...
 */
class Svac3RtpDecoder : public RtpCodec{
public:
    using Ptr = std::shared_ptr<Svac3RtpDecoder>;
...
private:
    ...
    Svac3Frame::Ptr obtainFrame();
    void outputFrame(const RtpPacket::Ptr &rtp, const Svac3Frame::Ptr &frame);
 ...
 */
class Svac3RtpEncoder : public RtpCodec {
public:
    using Ptr = std::shared_ptr<Svac3RtpEncoder>;
