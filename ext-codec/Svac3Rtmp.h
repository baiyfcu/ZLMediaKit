...
#ifndef ZLMEDIAKIT_SVAC3RTMPCODEC_H
#define ZLMEDIAKIT_SVAC3RTMPCODEC_H
 ...
 */
class Svac3RtmpDecoder : public RtmpCodec {
public:
    using Ptr = std::shared_ptr<Svac3RtmpDecoder>;

    Svac3RtmpDecoder(const Track::Ptr &track) : RtmpCodec(track) {}
 ...
 */
class Svac3RtmpEncoder : public RtmpCodec {
public:
    using Ptr = std::shared_ptr<Svac3RtmpEncoder>;
     ...
     */
    Svac3RtmpEncoder(const Track::Ptr &track) : RtmpCodec(track) {}
