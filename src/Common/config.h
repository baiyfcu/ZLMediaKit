...
extern MK_EXPORT const std::string kBroadcastMediaChanged;
...
extern MK_EXPORT const std::string kBroadcastHttpRequest;
...
extern MK_EXPORT const std::string kBroadcastHttpAccess;
...
extern MK_EXPORT const std::string kBroadcastHttpBeforeAccess;
...
extern MK_EXPORT const std::string kBroadcastOnGetRtspRealm;
...
extern MK_EXPORT const std::string kBroadcastOnRtspAuth;
...
extern MK_EXPORT const std::string kBroadcastMediaPublish;
...
extern MK_EXPORT const std::string kBroadcastMediaPlayed;
...
extern MK_EXPORT const std::string kBroadcastShellLogin;
...
extern MK_EXPORT const std::string kBroadcastFlowReport;
...
extern MK_EXPORT const std::string kBroadcastNotFoundStream;
...
extern MK_EXPORT const std::string kBroadcastStreamNoneReader;
...
extern MK_EXPORT const std::string kBroadcastSendRtpStopped;
...
extern MK_EXPORT const std::string kBroadcastReloadConfig;
#define BroadcastReloadConfigArgs void

// rtp server 超时  [AUTO-TRANSLATED:a65573fd]
// Rtp server timeout
extern MK_EXPORT const std::string kBroadcastRtpServerTimeout;
...
extern MK_EXPORT const std::string kBroadcastRtcSctpConnecting;
extern MK_EXPORT const std::string kBroadcastRtcSctpConnected;
extern MK_EXPORT const std::string kBroadcastRtcSctpFailed;
extern MK_EXPORT const std::string kBroadcastRtcSctpClosed;
...
extern MK_EXPORT const std::string kBroadcastRtcSctpSend;
...
extern MK_EXPORT const std::string kBroadcastRtcSctpReceived;
...
extern MK_EXPORT const std::string kBroadcastPlayerCountChanged;
...
extern MK_EXPORT const std::string kStreamNoneReaderDelayMS;
...
extern MK_EXPORT const std::string kMaxStreamWaitTimeMS;
// 是否启动虚拟主机  [AUTO-TRANSLATED:e1cea728]
// Whether to enable virtual host
extern MK_EXPORT const std::string kEnableVhost;
...
extern MK_EXPORT const std::string kResetWhenRePlay;
...
extern MK_EXPORT const std::string kMergeWriteMS;
...
extern MK_EXPORT const std::string kCheckNvidiaDev;
// 是否开启ffmpeg日志  [AUTO-TRANSLATED:038b471e]
// Whether to enable ffmpeg log
extern MK_EXPORT const std::string kEnableFFmpegLog;
...
extern MK_EXPORT const std::string kWaitTrackReadyMS;
//最多等待音频Track收到数据时间，单位毫秒，超时且完全没收到音频数据，忽略音频Track
//加快某些带封装的流metadata说明有音频，但是实际上没有的流ready时间（比如很多厂商的GB28181 PS）
extern MK_EXPORT const std::string kWaitAudioTrackDataMS;
...
extern MK_EXPORT const std::string kWaitAddTrackMS;
...
extern MK_EXPORT const std::string kUnreadyFrameCache;
...
extern MK_EXPORT const std::string kListenIP;
} // namespace General
...
extern MK_EXPORT const std::string kAutoClose;
...
extern MK_EXPORT const std::string kContinuePushMS;
...
extern MK_EXPORT const std::string kForwardedIpHeader;
// 是否允许所有跨域请求  [AUTO-TRANSLATED:2551c096]
// Whether to allow all cross-domain requests
extern MK_EXPORT const std::string kAllowCrossDomains;
...
extern MK_EXPORT const std::string kAllowIPRange;
} // namespace Http
...
extern MK_EXPORT const std::string kAuthBasic;
// 握手超时时间，默认15秒  [AUTO-TRANSLATED:6f69a65b]
// Handshake timeout, default 15 seconds
extern MK_EXPORT const std::string kHandshakeSecond;
...
extern MK_EXPORT const std::string kDirectProxy;
...
extern MK_EXPORT const std::string kLowLatency;
...
extern MK_EXPORT const std::string kRtpTransportType;
} // namespace Rtsp
...
extern MK_EXPORT const std::string kEnhanced;
} // namespace Rtmp
...
extern MK_EXPORT const std::string kVideoMtuSize;
// RTP打包最大MTU,公网情况下更小  [AUTO-TRANSLATED:869f5c4b]
// Maximum RTP packet MTU, smaller in public network
extern MK_EXPORT const std::string kAudioMtuSize;
// rtp包最大长度限制, 单位KB  [AUTO-TRANSLATED:1da42584]
// Maximum RTP packet length limit, unit KB
extern MK_EXPORT const std::string kRtpMaxSize;
...
extern MK_EXPORT const std::string kH264StapA;
} // namespace Rtp
...
extern MK_EXPORT const std::string kAddrMin;
// 组播分配截止地址  [AUTO-TRANSLATED:6d3fc54c]
// Multicast allocation end address
extern MK_EXPORT const std::string kAddrMax;
// 组播TTL  [AUTO-TRANSLATED:c7c5339c]
// Multicast TTL
extern MK_EXPORT const std::string kUdpTTL;
} // namespace MultiCast
...
extern MK_EXPORT const std::string kSegmentDuration;
...
extern MK_EXPORT const std::string kSegmentNum;
...
extern MK_EXPORT const std::string kSegmentKeep;
...
extern MK_EXPORT const std::string kSegmentDelay;
...
extern MK_EXPORT const std::string kSegmentRetain;
...
extern MK_EXPORT const std::string kDumpDir;
// rtp接收超时时间  [AUTO-TRANSLATED:9e918489]
// Rtp receive timeout
extern MK_EXPORT const std::string kTimeoutSec;
...
extern MK_EXPORT const std::string kPortRange;
// rtp server h264的pt  [AUTO-TRANSLATED:b8cf877b]
// Rtp server h264 pt
extern MK_EXPORT const std::string kH264PT;
// rtp server h265的pt  [AUTO-TRANSLATED:2bdb1dfb]
// Rtp server h265 pt
extern MK_EXPORT const std::string kH265PT;
// rtp server ps 的pt  [AUTO-TRANSLATED:6feaf5f9]
// Rtp server ps pt
extern MK_EXPORT const std::string kPSPT;
// rtp server opus 的pt  [AUTO-TRANSLATED:9f91f85a]
// Rtp server opus pt
extern MK_EXPORT const std::string kOpusPT;
...
extern MK_EXPORT const std::string kGopCache;
...
extern MK_EXPORT const std::string kRtpG711DurMs;
// udp recv socket buffer size
extern MK_EXPORT const std::string kUdpRecvSocketBuffer;
} // namespace RtpProxy
...
extern MK_EXPORT const std::string kNetAdapter;
...
extern MK_EXPORT const std::string kRtpType;
...
extern MK_EXPORT const std::string kRtspBeatType;
// rtsp认证用户名  [AUTO-TRANSLATED:5ab80e57]
// RTSP authentication username
extern MK_EXPORT const std::string kRtspUser;
...
extern MK_EXPORT const std::string kBenchmarkMode;
...
extern MK_EXPORT const std::string kWaitTrackReady;
