...
extern ZLMEDIAKIT_API const std::string kBroadcastMediaChanged;
...
extern ZLMEDIAKIT_API const std::string kBroadcastHttpRequest;
...
extern ZLMEDIAKIT_API const std::string kBroadcastHttpAccess;
...
extern ZLMEDIAKIT_API const std::string kBroadcastHttpBeforeAccess;
...
extern ZLMEDIAKIT_API const std::string kBroadcastOnGetRtspRealm;
...
extern ZLMEDIAKIT_API const std::string kBroadcastOnRtspAuth;
...
extern ZLMEDIAKIT_API const std::string kBroadcastMediaPublish;
...
extern ZLMEDIAKIT_API const std::string kBroadcastMediaPlayed;
...
extern ZLMEDIAKIT_API const std::string kBroadcastShellLogin;
...
extern ZLMEDIAKIT_API const std::string kBroadcastFlowReport;
...
extern ZLMEDIAKIT_API const std::string kBroadcastNotFoundStream;
...
extern ZLMEDIAKIT_API const std::string kBroadcastStreamNoneReader;
...
extern ZLMEDIAKIT_API const std::string kBroadcastSendRtpStopped;
...
// Rtp server timeout
extern ZLMEDIAKIT_API const std::string kBroadcastRtpServerTimeout;
...
extern ZLMEDIAKIT_API const std::string kBroadcastRtcSctpConnecting;
extern ZLMEDIAKIT_API const std::string kBroadcastRtcSctpConnected;
extern ZLMEDIAKIT_API const std::string kBroadcastRtcSctpFailed;
extern ZLMEDIAKIT_API const std::string kBroadcastRtcSctpClosed;
...
extern ZLMEDIAKIT_API const std::string kBroadcastRtcSctpSend;
...
extern ZLMEDIAKIT_API const std::string kBroadcastRtcSctpReceived;
...
extern ZLMEDIAKIT_API const std::string kBroadcastPlayerCountChanged;
...
ZLMEDIAKIT_API extern const std::string kStreamNoneReaderDelayMS;
...
ZLMEDIAKIT_API extern const std::string kMaxStreamWaitTimeMS;
// 是否启动虚拟主机  [AUTO-TRANSLATED:e1cea728]
// Whether to enable virtual host
ZLMEDIAKIT_API extern const std::string kEnableVhost;
...
ZLMEDIAKIT_API extern const std::string kResetWhenRePlay;
...
ZLMEDIAKIT_API extern const std::string kMergeWriteMS;
...
ZLMEDIAKIT_API extern const std::string kCheckNvidiaDev;
// 是否开启ffmpeg日志  [AUTO-TRANSLATED:038b471e]
// Whether to enable ffmpeg log
ZLMEDIAKIT_API extern const std::string kEnableFFmpegLog;
...
ZLMEDIAKIT_API extern const std::string kWaitTrackReadyMS;
//最多等待音频Track收到数据时间，单位毫秒，超时且完全没收到音频数据，忽略音频Track
//加快某些带封装的流metadata说明有音频，但是实际上没有的流ready时间（比如很多厂商的GB28181 PS）
ZLMEDIAKIT_API extern const std::string kWaitAudioTrackDataMS;
...
ZLMEDIAKIT_API extern const std::string kWaitAddTrackMS;
...
ZLMEDIAKIT_API extern const std::string kUnreadyFrameCache;
...
ZLMEDIAKIT_API extern const std::string kBroadcastPlayerCountChanged;
// 绑定的本地网卡ip  [AUTO-TRANSLATED:daa90832]
// Bound local network card ip
ZLMEDIAKIT_API extern const std::string kListenIP;
} // namespace General
...
ZLMEDIAKIT_API extern const std::string kAutoClose;
...
ZLMEDIAKIT_API extern const std::string kContinuePushMS;
...
ZLMEDIAKIT_API extern const std::string kPacedSenderMS;

// 是否开启转换为hls(mpegts)  [AUTO-TRANSLATED:bfc1167a]
// Whether to enable conversion to HLS (MPEGTS)
ZLMEDIAKIT_API extern const std::string kEnableHls;
// 是否开启转换为hls(fmp4)  [AUTO-TRANSLATED:20548673]
// Whether to enable conversion to HLS (FMP4)
ZLMEDIAKIT_API extern const std::string kEnableHlsFmp4;
// 是否开启MP4录制  [AUTO-TRANSLATED:0157b014]
// Whether to enable MP4 recording
ZLMEDIAKIT_API extern const std::string kEnableMP4;
// 是否开启转换为rtsp/webrtc  [AUTO-TRANSLATED:0711cb18]
// Whether to enable conversion to RTSP/WebRTC
ZLMEDIAKIT_API extern const std::string kEnableRtsp;
// 是否开启转换为rtmp/flv  [AUTO-TRANSLATED:d4774119]
// Whether to enable conversion to RTMP/FLV
ZLMEDIAKIT_API extern const std::string kEnableRtmp;
// 是否开启转换为http-ts/ws-ts  [AUTO-TRANSLATED:51acc798]
// Whether to enable conversion to HTTP-TS/WS-TS
ZLMEDIAKIT_API extern const std::string kEnableTS;
// 是否开启转换为http-fmp4/ws-fmp4  [AUTO-TRANSLATED:8c96e1e4]
// Whether to enable conversion to HTTP-FMP4/WS-FMP4
ZLMEDIAKIT_API extern const std::string kEnableFMP4;

// 是否将mp4录制当做观看者  [AUTO-TRANSLATED:ba351230]
// Whether to treat MP4 recording as a viewer
ZLMEDIAKIT_API extern const std::string kMP4AsPlayer;
// mp4切片大小，单位秒  [AUTO-TRANSLATED:c3fb8ec1]
// MP4 fragment size, unit is seconds
ZLMEDIAKIT_API extern const std::string kMP4MaxSecond;
// mp4录制保存路径  [AUTO-TRANSLATED:b8b7b7b7]
// MP4 recording save path
ZLMEDIAKIT_API extern const std::string kMP4SavePath;

// hls保存路径  [AUTO-TRANSLATED:b8b7b7b7]
// HLS save path
ZLMEDIAKIT_API extern const std::string kHlsSavePath;

// 按需转协议的开关  [AUTO-TRANSLATED:b8b7b7b7]
// Switch for on-demand protocol conversion
ZLMEDIAKIT_API extern const std::string kHlsDemand;
ZLMEDIAKIT_API extern const std::string kRtspDemand;
ZLMEDIAKIT_API extern const std::string kRtmpDemand;
ZLMEDIAKIT_API extern const std::string kTSDemand;
ZLMEDIAKIT_API extern const std::string kFMP4Demand;
} // !Protocol

// //////////HTTP配置///////////  [AUTO-TRANSLATED:a281d694]
// //////////HTTP configuration///////////
namespace Http {
static constexpr char kFieldName[] = "http.";
// http 文件发送缓存大小  [AUTO-TRANSLATED:b1b7b9b8]
// HTTP file send cache size
ZLMEDIAKIT_API extern const std::string kSendBufSize;
// http 最大请求字节数  [AUTO-TRANSLATED:b1b7b9b8]
// HTTP maximum request bytes
ZLMEDIAKIT_API extern const std::string kMaxReqSize;
// http keep-alive秒数  [AUTO-TRANSLATED:b1b7b9b8]
// HTTP keep-alive seconds
ZLMEDIAKIT_API extern const std::string kKeepAliveSecond;
// http 字符编码  [AUTO-TRANSLATED:b1b7b9b8]
// HTTP character encoding
ZLMEDIAKIT_API extern const std::string kCharSet;
// http 服务器根目录  [AUTO-TRANSLATED:b1b7b9b8]
// HTTP server root directory
ZLMEDIAKIT_API extern const std::string kRootPath;
// http 服务器虚拟目录 虚拟目录名和文件路径使用","隔开  [AUTO-TRANSLATED:b1b7b9b8]
// HTTP server virtual directory, virtual directory name and file path are separated by ","
ZLMEDIAKIT_API extern const std::string kVirtualPath;
// http 404错误提示内容  [AUTO-TRANSLATED:b1b7b9b8]
// HTTP 404 error message content
ZLMEDIAKIT_API extern const std::string kNotFound;
// 是否显示文件夹菜单  [AUTO-TRANSLATED:b1b7b9b8]
// Whether to show folder menu
ZLMEDIAKIT_API extern const std::string kDirMenu;
// 禁止缓存文件的后缀  [AUTO-TRANSLATED:b1b7b9b8]
// File suffixes that prohibit caching
ZLMEDIAKIT_API extern const std::string kForbidCacheSuffix;
// 可以把http代理前真实客户端ip放在http头中：https://github.com/ZLMediaKit/ZLMediaKit/issues/1388  [AUTO-TRANSLATED:b1b7b9b8]
...
ZLMEDIAKIT_API extern const std::string kForwardedIpHeader;
// 是否允许跨域  [AUTO-TRANSLATED:b1b7b9b8]
// Whether to allow cross-domain
ZLMEDIAKIT_API extern const std::string kAllowCrossDomains;
// 允许访问http api和http文件索引的ip范围  [AUTO-TRANSLATED:b1b7b9b8]
// IP range allowed to access HTTP API and HTTP file index
ZLMEDIAKIT_API extern const std::string kAllowIPRange;
} // namespace Http

// //////////SHELL配置///////////  [AUTO-TRANSLATED:b1b7b9b8]
// //////////SHELL Configuration///////////
namespace Shell {
ZLMEDIAKIT_API extern const std::string kMaxReqSize;
} // namespace Shell

// //////////RTSP服务器配置///////////  [AUTO-TRANSLATED:b1b7b9b8]
// //////////RTSP Server Configuration///////////
namespace Rtsp {
static constexpr char kFieldName[] = "rtsp.";
// 是否优先tcp方式播放，当使用tcp方式播放时，支持的播放客户端会更多  [AUTO-TRANSLATED:b1b7b9b8]
// Whether to prioritize TCP playback, when using TCP playback, more playback clients will be supported
ZLMEDIAKIT_API extern const std::string kAuthBasic;
// rtsp握手超时时间，默认15秒  [AUTO-TRANSLATED:b1b7b9b8]
// RTSP handshake timeout, default 15 seconds
ZLMEDIAKIT_API extern const std::string kHandshakeSecond;
// rtsp超时时间，默认15秒  [AUTO-TRANSLATED:b1b7b9b8]
// RTSP timeout, default 15 seconds
ZLMEDIAKIT_API extern const std::string kKeepAliveSecond;
// 是否直接代理，开启后支持任意编码格式，但是摄像头画面将不能在web浏览器直接观看  [AUTO-TRANSLATED:b1b7b9b8]
// Whether to directly proxy, after enabling, any encoding format is supported, but the camera screen cannot be directly viewed in the web browser
ZLMEDIAKIT_API extern const std::string kDirectProxy;
// rtsp低延迟模式，开启后将关闭GOP缓存  [AUTO-TRANSLATED:b1b7b9b8]
// RTSP low latency mode, GOP cache will be disabled after enabling
ZLMEDIAKIT_API extern const std::string kLowLatency;
...
ZLMEDIAKIT_API extern const std::string kRtpTransportType;
} // namespace Rtsp

// //////////RTMP服务器配置///////////  [AUTO-TRANSLATED:b1b7b9b8]
// //////////RTMP Server Configuration///////////
namespace Rtmp {
static constexpr char kFieldName[] = "rtmp.";
// rtmp握手超时时间，默认15秒  [AUTO-TRANSLATED:b1b7b9b8]
// RTMP handshake timeout, default 15 seconds
ZLMEDIAKIT_API extern const std::string kHandshakeSecond;
// rtmp超时时间，默认15秒  [AUTO-TRANSLATED:b1b7b9b8]
// RTMP timeout, default 15 seconds
ZLMEDIAKIT_API extern const std::string kKeepAliveSecond;
...
ZLMEDIAKIT_API extern const std::string kEnhanced;
} // namespace Rtmp
...
ZLMEDIAKIT_API extern const std::string kVideoMtuSize;
// RTP打包最大MTU,公网情况下更小  [AUTO-TRANSLATED:869f5c4b]
// Maximum RTP packet MTU, smaller in public network
ZLMEDIAKIT_API extern const std::string kAudioMtuSize;
// rtp包最大长度限制, 单位KB  [AUTO-TRANSLATED:1da42584]
// Maximum RTP packet length limit, unit KB
ZLMEDIAKIT_API extern const std::string kRtpMaxSize;
...
ZLMEDIAKIT_API extern const std::string kH264StapA;
} // namespace Rtp
...
ZLMEDIAKIT_API extern const std::string kAddrMin;
// 组播分配截止地址  [AUTO-TRANSLATED:6d3fc54c]
// Multicast allocation end address
ZLMEDIAKIT_API extern const std::string kAddrMax;
// 组播TTL  [AUTO-TRANSLATED:c7c5339c]
// Multicast TTL
ZLMEDIAKIT_API extern const std::string kUdpTTL;
} // namespace MultiCast
...
ZLMEDIAKIT_API extern const std::string kFastStart;
// mp4文件是否重头循环读取  [AUTO-TRANSLATED:69ac72de]
// Whether to loop read the MP4 file from the beginning
ZLMEDIAKIT_API extern const std::string kFileRepeat;
...
ZLMEDIAKIT_API extern const std::string kSegmentDuration;
...
ZLMEDIAKIT_API extern const std::string kSegmentNum;
...
ZLMEDIAKIT_API extern const std::string kSegmentKeep;
...
ZLMEDIAKIT_API extern const std::string kSegmentDelay;
...
ZLMEDIAKIT_API extern const std::string kSegmentRetain;
...
ZLMEDIAKIT_API extern const std::string kDumpDir;
// rtp接收超时时间  [AUTO-TRANSLATED:9e918489]
// Rtp receive timeout
ZLMEDIAKIT_API extern const std::string kTimeoutSec;
...
ZLMEDIAKIT_API extern const std::string kPortRange;
// rtp server h264的pt  [AUTO-TRANSLATED:b8cf877b]
// Rtp server h264 pt
ZLMEDIAKIT_API extern const std::string kH264PT;
// rtp server h265的pt  [AUTO-TRANSLATED:2bdb1dfb]
// Rtp server h265 pt
ZLMEDIAKIT_API extern const std::string kH265PT;
// rtp server ps 的pt  [AUTO-TRANSLATED:6feaf5f9]
// Rtp server ps pt
ZLMEDIAKIT_API extern const std::string kPSPT;
// rtp server opus 的pt  [AUTO-TRANSLATED:9f91f85a]
// Rtp server opus pt
ZLMEDIAKIT_API extern const std::string kOpusPT;
...
ZLMEDIAKIT_API extern const std::string kGopCache;
...
ZLMEDIAKIT_API extern const std::string kRtpG711DurMs;
// udp recv socket buffer size
ZLMEDIAKIT_API extern const std::string kUdpRecvSocketBuffer;
} // namespace RtpProxy
...
ZLMEDIAKIT_API extern const std::string kNetAdapter;
...
ZLMEDIAKIT_API extern const std::string kRtpType;
...
ZLMEDIAKIT_API extern const std::string kRtspBeatType;
// rtsp认证用户名  [AUTO-TRANSLATED:5ab80e57]
// RTSP authentication username
ZLMEDIAKIT_API extern const std::string kRtspUser;
...
ZLMEDIAKIT_API extern const std::string kBenchmarkMode;
...
ZLMEDIAKIT_API extern const std::string kWaitTrackReady;
// rtsp播放指定track，可选项有0(不指定，默认)、1(视频)、2(音频)  [AUTO-TRANSLATED:e4f481f9]
// RTSP播放指定track，options are 0 (not specified, default), 1 (video), 2 (audio)
// 设置方法:player[Client::kPlayTrack] = 0/1/2;  [AUTO-TRANSLATED:0a2705c8]
// Set method: player[Client::kPlayTrack] = 0/1/2;
ZLMEDIAKIT_API extern const std::string kPlayTrack;
// 设置代理url，目前只支持http协议  [AUTO-TRANSLATED:c84918cc]
// Set proxy url, currently only supports http protocol
ZLMEDIAKIT_API extern const std::string kProxyUrl;
// 设置开始rtsp倍速播放  [AUTO-TRANSLATED:5db03cad]
// Set the start RTSP playback speed
ZLMEDIAKIT_API extern const std::string kRtspSpeed;
// Set SRT delay
ZLMEDIAKIT_API extern const std::string kLatency;
// Set SRT PassPhrase
ZLMEDIAKIT_API extern const std::string kPassPhrase;
} // namespace Client
} // namespace mediakit
