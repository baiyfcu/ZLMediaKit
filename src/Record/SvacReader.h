...
#ifndef SRC_MEDIAFILE_MEDIAREADER_SVAC_H_
#define SRC_MEDIAFILE_MEDIAREADER_SVAC_H_
#ifdef ENABLE_MP4
...
class SvacReader : public std::enable_shared_from_this<SvacReader>, public MediaSourceEvent {
public:
    using Ptr = std::shared_ptr<SvacReader>;
     ...
     */
    SvacReader(const MediaTuple &tuple, const std::string &file_path = "", toolkit::EventPoller::Ptr poller = nullptr);

    SvacReader(const MediaTuple &tuple, const std::string &file_path, const ProtocolOption &option, toolkit::EventPoller::Ptr poller = nullptr);
     ...
     */
    const SvacDemuxer::Ptr& getDemuxer() const;
...
#endif //ENABLE_MP4
#endif /* SRC_MEDIAFILE_MEDIAREADER_SVAC_H_ */
